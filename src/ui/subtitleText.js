export const subtitles = {
  hackScene: [
    ...
    {
      trigger: -30,
      text: "That claim opens a door. If the breach is one more tool, then what came before it? What tradition is Guacamaya situating themselves within, and what does it mean to make that tradition legible without collapsing the distinct, complex histories of the peoples who have lived it?"
    },
    {
      trigger: -48,
    ...
    {
      trigger: -62,
      text: "Pierce calls this kinstillation: the enacting of ancestral knowledge in the present, linking acts of land defense across time and space as a living relation rather than a linear history. Guacamaya's breach is a kinstillation. And to understand it as one, you have to understand what has always been at stake."
    }
  ],
  ...
  scene1: [
    ...
    {
      trigger: -48,
      text: "That structure is ongoing. It has not concluded. And the reason it has not concluded is that Indigenous peoples have never stopped defending the land, which means they have never stopped posing a challenge to everything settler colonialism requires."
    },
    {
      trigger: -62,
      text: "This is what is at stake in every act of land defense that follows: not only territory, but the web of relations that makes the land meaningful, the kinship between human and non-human worlds that settler colonialism has always needed to sever and has never fully managed to."
    }
  ],
  ...
  scene5: [
    ...
    {
      trigger: -433,
      text: "Around 3,000 people were killed in the El Estor region between 1970 and 1980. On May 29, 1978, approximately 700 Maya Q'eqchi' people marched to Panzós to demand their land title be respected. They were unarmed. Guatemalan Army soldiers opened fire, killing at least 140 people."
    },
    {
      trigger: -452,
      text: "Through each reopening of the mine, Maya Q'eqchi' communities organized through community assemblies, legal challenges, and international solidarity networks, recentring their own practices and ceremonies as forms of continuity, connecting the violence of the mine to the genocidal massacres of the civil war, refusing to let either be treated as history."
    },
    {
      trigger: -470,
